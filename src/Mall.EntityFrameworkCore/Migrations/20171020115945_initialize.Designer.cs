...
namespace Mall.Migrations
{
    ...
    [Migration("20171020115945_initialize")]
            ...
            modelBuilder.Entity("Mall.Domain.Entities.Mall_CartItem", b =>
                {
                    ...
                    b.Property<int?>("Mall_CartId");

                    b.Property<int>("ProductId");

                    b.HasKey("Id");

                    b.HasIndex("Mall_CartId");

                    b.ToTable("Mall_CartItems");
                });
            ...
            modelBuilder.Entity("Mall.Domain.Entities.Mall_Product", b =>
                {
                    ...
                    b.ToTable("Mall_Products");
                });

            modelBuilder.Entity("Mall.Domain.Entities.Mall_CartItem", b =>
                {
                    b.HasOne("Mall.Domain.Entities.Mall_Cart")
                        .WithMany("_cartItemList")
                        .HasForeignKey("Mall_CartId");
                });
