...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function (exports) {
    ...
    //字符常量
    , MOD_NAME = 'abptable', ELEM = '.layui-table', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'layui-disabled', NONE = 'layui-none'
    ...
    Class.prototype.pullData = function (curr, loadIndex) {
        ...
        if (options.url) { //Ajax请求
            ...
            //这个是自定义的数据
            params["skipCount"] = (parseInt(curr) - 1) * parseInt(options.limit);
            $.ajax({
              ...
              , success: function (res) {
                  ...
                  //此处对数据特殊处理,用于试用abp
                  that.renderData(res.result, curr, res.result[response.countName]), sort();
