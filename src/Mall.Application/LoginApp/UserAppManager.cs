...
namespace Mall.UserApp
{
    ...
    [AbpAllowAnonymous]
    public class UserAppService : AsyncCrudAppService<Mall_Account, UserDto, long, GetUsersInput, CreateUserInput, UpdateUserInput>, IUserAppService
    {
        private IRepository<Mall_Account, long> _accountRepository;
        private IUserCache _userCache;

        public UserAppService(IRepository<Mall_Account, long> userRepository, IUserCache userCache) : base(userRepository)
        {
